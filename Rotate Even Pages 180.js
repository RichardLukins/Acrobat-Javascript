...
//   ************************************************************************************
//   *****                                                                          *****
//   *****    	        	ROTATE EVEN PAGES ONLY 180 DEGREES                      *****
//   *****                                                                          *****
//   ************************************************************************************
//   ************************************************************************************
//
...
app.addMenuItem({  cName: "Rotate Even Pages 180", cParent: "Edit", cExec: "RotEvenPages180();",  cEnable: "event.rc = (event.target != null);", nPos: 0 });
//
// Define the Function
//
RotEvenPages180 = app.trustedFunction(function() {
	try { // start error trapping
		...
		if (this.numPages > 0) { // check there is at least 1 page to work on
			...
			if (nRslt == 1) {		
				...
				tmr.begin();
				for (var i=1; i< this.numPages; i=i+2) { // loop through EVEN pages only, one at a time
